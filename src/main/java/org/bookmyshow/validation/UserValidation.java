...
public class UserValidation {
    ...
    public final static boolean isEmailExists(String email) throws SQLException {
    ...
    public final static boolean isPhoneNumberExists(String phone) throws SQLException {
        try (Connection connection = PostgreSQLConnection.getConnection()) {
