...
public class UserLoginController {
    ...
    @Inject
    private UserLoginController(final UserLoginService userLoginService){
    ...
    public final Response loginUser(final User loginRequest, @Context final HttpServletRequest request) {
