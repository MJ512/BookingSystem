...
@Singleton
public class MovieShowRepositoryImpl implements ShowRepository {

    private static final Logger logger = Logger.getLogger(MovieShowRepositoryImpl.class.getName());

    public final boolean hasShowStarted(final int showId) {
