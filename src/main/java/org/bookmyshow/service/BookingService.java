...
public class BookingService {
    ...
    private final ShowRepository showDAO;
    private final BookingValidator validator;
    private final SeatRepository seatDAO;

    @Inject
    public BookingService(final BookingRepository bookingDAO, final ShowRepository showDAO,
                          final BookingValidator validator, final SeatRepository seatDAO) {
